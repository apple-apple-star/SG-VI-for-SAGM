...
def read_records(serialized_example):
    ...
    return edge, global_mini_batch_pi, local_mini_batch_indices, curr_indices_train_indices_0, curr_indices_train_indices_1, curr_indices_test_indices_0, curr_indices_test_indices_1

def assign_record(iterator, global_mini_batch_indices,  m_tf, L_tf, num_train_edge_each_node_tf,
                  local_mini_batch_indices_m, curr_indices_train_indices, curr_indices_test_indices):

    edge, global_mini_batch_pi, local_mini_batch_indices, curr_indices_train_indices_0, curr_indices_train_indices_1, curr_indices_test_indices_0, curr_indices_test_indices_1 = iterator.get_next()
    curr = edge
    ...
    curr_indices_test_indices = tf.assign(curr_indices_test_indices,
                                          ...
                                          validate_shape=False)
    return curr, global_mini_batch_indices, local_mini_batch_indices_m, curr_indices_train_indices, curr_indices_test_indices

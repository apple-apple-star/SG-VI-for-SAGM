...
for k in K:
    ...
    plt.hist([all_auc_svi_reimann, all_auc_svi], bins=10, label=['With preconditioner', 'Without preconditioner'])
...
plt.savefig("synthetic_agm_graph_svi_svi_K.pdf")
plt.savefig("synthetic_agm_graph_svi_svi_K.png")